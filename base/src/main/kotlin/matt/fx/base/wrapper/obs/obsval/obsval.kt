...
fun <T> ObservableValue<T & Any>.toNullableROProp() = NullableFXBackedReadOnlyBindableProp(this)
...
interface ReadableFXBackedPropBinder<FX_T> {
  fun booleanBinding(vararg dependencies: Observable, op: (FX_T?)->Boolean): BooleanBinding
  fun integerBinding(vararg dependencies: Observable, op: (FX_T?)->Int): IntegerBinding
  fun longBinding(vararg dependencies: Observable, op: (FX_T?)->Long): LongBinding
  fun doubleBinding(vararg dependencies: Observable, op: (FX_T?)->Double): DoubleBinding
  fun floatBinding(vararg dependencies: Observable, op: (FX_T?)->Float): FloatBinding
  fun <T> objectBinding(vararg dependencies: Observable, op: (FX_T?)->T): ObjectBinding<T>
  fun stringBinding(vararg dependencies: Observable, op: (FX_T?)->String): StringBinding
}

private class ReadingBinder<FX_T>(private val o: ObservableValue<FX_T>): ReadableFXBackedPropBinder<FX_T> {

  override fun booleanBinding(vararg dependencies: Observable, op: (FX_T?)->Boolean): BooleanBinding =
	Bindings.createBooleanBinding({ op(o.value) }, o, *dependencies)

  override fun integerBinding(vararg dependencies: Observable, op: (FX_T?)->Int): IntegerBinding =
	Bindings.createIntegerBinding({ op(o.value) }, o, *dependencies)

  override fun longBinding(vararg dependencies: Observable, op: (FX_T?)->Long): LongBinding =
	Bindings.createLongBinding({ op(o.value) }, o, *dependencies)

  override fun doubleBinding(vararg dependencies: Observable, op: (FX_T?)->Double): DoubleBinding =
	Bindings.createDoubleBinding({ op(o.value) }, o, *dependencies)

  override fun floatBinding(vararg dependencies: Observable, op: (FX_T?)->Float): FloatBinding =
	Bindings.createFloatBinding({ op(o.value) }, o, *dependencies)

  override fun <T> objectBinding(vararg dependencies: Observable, op: (FX_T?)->T): ObjectBinding<T> =
	Bindings.createObjectBinding({ op(o.value) }, o, *dependencies)

  override fun stringBinding(vararg dependencies: Observable, op: (FX_T?)->String): StringBinding =
