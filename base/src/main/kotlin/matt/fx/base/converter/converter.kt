...
fun <I, O> callbackConverter() = object : BiConverter<Callback<I, ObservableValue<O>>, Callback<I, ObsVal<O>>> {
    ...
    override fun convertToB(a: Callback<I, ObservableValue<O>>): Callback<I, ObsVal<O>> = Callback<I, ObsVal<O>> { param ->
        val o = a.call(param)!!
    ...
    override fun convertToA(b: Callback<I, ObsVal<O>>): Callback<I, ObservableValue<O>> = Callback<I, ObservableValue<O>> { param -> b.call(param).createROFXPropWrapper() }
