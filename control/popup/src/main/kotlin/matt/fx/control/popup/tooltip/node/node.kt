...
class MyTooltip @JvmOverloads constructor(text: String? = null) : MyPopupControl() {
    ...
    companion object {
        ...
        fun uninstall(
            node: Node?,
            @Suppress("UNUSED_PARAMETER") t: MyTooltip?
        ...
        private val GRAPHIC: CssMetaData<MyToolTipCSSBridge, String> =
            object : CssMetaData<MyToolTipCSSBridge, String>("-fx-graphic", StringConverter.getInstance()) {
                override fun isSettable(cssBridge: MyToolTipCSSBridge) =
                    !cssBridge.popupControl.graphicProperty().isBound

                override fun getStyleableProperty(cssBridge: MyToolTipCSSBridge) =
                    cssBridge.popupControl.imageUrlProperty()
            }
        private val CONTENT_DISPLAY: CssMetaData<MyToolTipCSSBridge, ContentDisplay> =
            object : CssMetaData<MyToolTipCSSBridge, ContentDisplay>(
                "-fx-content-display",
                EnumConverter(
