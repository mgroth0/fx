package matt.fx.control.chart.pie.pie
...
class PieChartForWrapper @JvmOverloads constructor(data: ObservableList<Data> = FXCollections.observableArrayList()) :
    ChartForPrivateProps() {
        ...
        private fun updateDataItemStyleClass(
            item: Data,
            index: Int
        ) {
...
*/
        ...
        class Data(
            ...
            fun getChart(): PieChartForWrapper? = chart.value
            ...
            @Suppress("unused")
            fun chartProperty(): ReadOnlyObjectProperty<PieChartForWrapper?> = chart.readOnlyProperty
            ...
            @Suppress("unused")
            fun pieValueProperty(): DoubleProperty = pieValue
            ...
            fun getCurrentPieValue(): Double = currentPieValue.value

            fun setCurrentPieValue(value: Double) {
                currentPieValue.value = value
            }

            fun currentPieValueProperty(): DoubleProperty = currentPieValue
            ...
            fun getRadiusMultiplier(): Double = radiusMultiplier.value

            fun setRadiusMultiplier(value: Double) {
                radiusMultiplier.value = value
            }

            fun radiusMultiplierProperty(): DoubleProperty = radiusMultiplier
     ...
     */
        ...
        companion object {
            ...
            private fun calcY(
                ...
                radius: Double,
                centerY: Double
            ): Double = (centerY + radius * Math.sin(Math.toRadians(-angle)))
