package matt.fx.control.chart.axis.cat.cat
...
class CategoryAxisForCatAxisWrapper : AxisForPackagePrivateProps<String> {
    ...
    internal val categories: ObjectProperty<ObservableList<String>> =
        object : ObjectPropertyBase<ObservableList<String>>() {
            ...
            override fun getName(): String = "categories"
        }
     ...
     */
    fun getCategories(): ObservableList<String>? = categories.get()
    ...
    private fun calculateNewFirstPos(
        length: Double,
        catSpacing: Double
    ): Double {
    ...
    override fun autoRange(length: Double): RangeProps {
        ...
        return CategoryRangeProps(
            allDataCategories = allDataCategories,
            newCategorySpacing = newCategorySpacing,
            newFirstPos = newFirstPos,
            tickLabelRotation = tickLabelRotation
        )
    }

    private fun calculateRequiredSize(
     ...
     */
    override fun calculateTickValues(
        length: Double,
        range: RangeProps
    ): List<String> = (range as CategoryRangeProps).allDataCategories
    ...
    override fun measureTickMarkSize(
        ...
        val rangeArray = range as CategoryRangeProps
        val tickLabelRotation = rangeArray.tickLabelRotation
    ...
    fun getAllDataCategories(): List<String> = allDataCategories
     ...
     */
    override fun isValueOnAxis(value: String): Boolean = getCategories()!!.indexOf("" + value) != -1
     ...
     */
    override fun toNumericValue(value: String): Double = getCategories()!!.indexOf(value).toDouble()
