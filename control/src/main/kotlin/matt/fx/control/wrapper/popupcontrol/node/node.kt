package matt.fx.control.wrapper.popupcontrol.node
...
open class MyPopupControl: PopupWindow(), Skinnable, Styleable {
  ...
  fun getMinHeight(): Double {
	return if (minHeight == null) USE_COMPUTED_SIZE else minHeight!!.get()
  }
   ...
   */
  fun getPrefHeight(): Double {
	return if (prefHeight == null) USE_COMPUTED_SIZE else prefHeight!!.get()
  }
