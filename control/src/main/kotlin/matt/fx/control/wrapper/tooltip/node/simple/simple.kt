package matt.fx.control.wrapper.tooltip.node.simple
...
class MyFixedTooltip constructor(): PopupWindow() {
  ...
  private class TooltipBehavior internal constructor(private val hideOnExit: Boolean) {
	...
	fun install(node: Node?, t: MyFixedTooltip) {
  ...
  companion object {
	 ...
	 * @see Tooltip
	 */
	fun install(node: Node?, t: MyFixedTooltip) = BEHAVIOR.install(node, t)
	 ...
	 * @see Tooltip
	 */
	fun uninstall(node: Node?, @Suppress("UNUSED_PARAMETER") t: MyFixedTooltip?) = BEHAVIOR.uninstall(node)
