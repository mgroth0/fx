...
class MenuWrapper(node: Menu): MenuItemWrapper<Menu>(node) {

  constructor(text: String? = null, g: Node? = null): this(Menu(text, g))
   ...
   */
  fun item(name: String, keyCombination: String, graphic: Node? = null, op: MenuItemWrapper<*>.()->Unit = {}) =
