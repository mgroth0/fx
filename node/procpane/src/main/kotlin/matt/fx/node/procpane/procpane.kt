...
import matt.lang.common.trip
import matt.lang.file.toJFile
import matt.lang.model.file.FsFile
import matt.log.j.logInvocation
...
context(matt.shell.commonj.context.ReapingShellExecutionContext)
@Suppress("unused")
class ProcessConsolePane(
    ...
    override val console = ProcessConsole(name, services)
    ...
    @Suppress("MemberVisibilityCanBePrivate")
    override val runningProp =
        BindableProperty(false).apply {
    ...
    private val autoRestart: Boolean by autoRestartProp

    val showProcessInspectPaneOption = BindableProperty(false)
    private val inspectBox =
        ProcessInspectPane(process).apply {
    ...
    override fun rund() =
        logInvocation {
            daemon("rund Thread") {
                ...
                registerProcessShutdownTask(p, andRecursiveDescendants = false /*just keeping old behavior. Though maybe I should set this to true, and maybe I should use{} to ensure the process is fully cleaned up inside this function?*/)
    ...
    init {
        ...
        hbox<ButtonWrapper> {
            ...
            this@ProcessConsolePane.theTimerText =
                text {
